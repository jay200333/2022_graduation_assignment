...
CROPPED_IMG_DIR = DATA_DIR + 'cropped_images/' # 크롭된 이미지 파일의 위치
N_CROPPED_IMG_DIR = DATA_DIR + 'n_cropped_images/' # 크롭된 결함 부분이 없는 이미지 파일의 위치
TEST_IMG_DIR = 'test_images/' # 테스트용
BOUNDING_BOX_MASK_DIR = DATA_DIR + 'boundingbox_images/' # Bounding box가 적용된 학습 이미지 파일의 위치
